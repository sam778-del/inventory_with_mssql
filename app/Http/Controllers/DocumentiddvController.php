...
class DocumentiddvController extends Controller
{
    ...
    {
        return view('documenti_ddv.index');
    }
    ...
    public function searchFatura(Request $request)
    {
        ...
        try {
            $result = Fornitor::where('piva', '=', $request->partita_iva)
                        ->get(['cod_fornitore', 'differenziatore_fornit_', 'ragione_sociale_forn_', 'DESTINATARIO_MERCE_RAGIONE_SOCIALE', 'DEST_MERCE_INDIRIZZO', 'DEST_MERCE_LUOGO']);
            
            return view('documenti_ddv.index', compact('result'));
        } catch (\Exception $e) {
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $document->destinazione_riga1 = $request->input('destinatario_sociale');
            $document->destinazione_riga2 = $request->input('dest_merce_indirizzo');
            $document->destinazione_riga3 = $request->input('dest_merce_luogo');
