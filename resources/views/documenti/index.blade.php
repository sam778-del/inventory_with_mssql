            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    @if(isset($result) && !empty($result))
                        {!! Form::open(["route" => ["documenti.store"], "class" => "validation", "method" => "POST", "id" => "submit-wizard"]) !!}
                            <input type="text" name="tipologia_documento_predefinita_su_acquisti" value="{{ $result[0]['tipologia_documento_predefinita_su_acquisti'] }}" />
                            <div class="d-flex justify-content-center">
                                <div class="col-sm-8">
                                        ...
                                        <div class="step-content">
                                            <div class="step-tab-panel" data-step="step1">
                                                <div class="row g-3 mb-5">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" id="var_fornitore" value="{{ $result[0]['differenziatore_fornit_'] }}" name="differenziatore_fornit_" class="form-control form-control-lg" >
                                                        </div>
                                                    </div>
                                                    <!-- <div class="col-sm-12">
                                            ...
                                            <div class="step-tab-panel" data-step="step2">
                                                <div class="row g-3 mb-5">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <p>{{ $result[0]['ragione_sociale_forn_'] }}</p>
                                                        <!-- <div class="input-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <label class="form-label">DESTINATARIO RAG.SOC</label>
                                                        <div class="input-group">
                                                            <input type="text" name="destinatario_sociale" value="{{ $result[0]['DESTINATARIO_MERCE_RAGIONE_SOCIALE'] }}" class="form-control form-control-lg" >
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="step-tab-panel" data-step="step3">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="DOC_NUMERO_DOCUMENTO" class="form-control form-control-lg" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <label class="form-label">Data documento</label>
                                                    <div class="input-group">
                                                        <input id="data_documento" type="text" name="DATA_DOCUMENTO" class="form-control form-control-lg" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script src="{{ asset('/bundles/daterangepicker.js') }}"></script>
<script src="{{ asset('/bundles/moment.min.js') }}"></script>
<script></script>
<script>
	$(document).ready(function() {
		$('#data_documento').val(moment().add(1, 'days').format('DD-MM-YYYY'));
	});

	$('#data_documento').daterangepicker({
		"locale": {
            "format": "MM/DD/YYYY",
            "separator": " - ",
            "applyLabel": "Apply",
		...
		$('#data_documento').val(chosen_date.format('DD-MM-YYYY'));
	});
</script>
<script>
    $(document).ready(function() {
